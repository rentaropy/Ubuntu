...
#wget https://raw.githubusercontent.com/maeda-doctoral/Ubuntu/main/AP-Server/Init_Setup_Container.sh && nano ./Init_Setup_Container.sh && chmod u+x ./Init_Setup_Container.sh && ./Init_Setup_Container.sh
