...
#wget https://raw.githubusercontent.com/maeda-doctoral/Ubuntu/main/AP-Server/Python39_Setup.sh && nano ./Python39_Setup.sh && chmod u+x ./Python39_Setup.sh && ./Python39_Setup.sh
...
sudo apt-get install -y mysql-server libpango-1.0-0 libpangoft2-1.0-0
