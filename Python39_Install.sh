#!/bin/bash
#wget https://raw.githubusercontent.com/rentaropy/Ubuntu/main/Python39_Install.sh && nano ./Python39_Install.sh && chmod u+x ./Python39_Install.sh && ./Python39_Install.sh
