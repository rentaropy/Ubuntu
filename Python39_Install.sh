#!/bin/bash
#wget https://raw.githubusercontent.com/maemune/Unix/main/Python39_Install.sh && nano ./Python39_Install.sh && chmod u+x ./PPython39_Install.sh && ./Python39_Install.sh
